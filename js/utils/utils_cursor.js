...
function cursorDraw(context_draw, canvas_draw, xCurr, yCurr, forecolor, cursorSize, symmetry, isStroke = false) {
    ...
    if (cursorSize == 0 && !isStroke) // specific cursor if hover at size 0
     {
        ...
        context_draw.moveTo(xCurr + 1, yCurr);
        context_draw.lineTo(xCurr + 10, yCurr);
        context_draw.stroke();
        context_draw.moveTo(xCurr - 1, yCurr);
        context_draw.lineTo(xCurr - 10, yCurr);
        context_draw.stroke();
        context_draw.moveTo(xCurr, yCurr + 1);
        context_draw.lineTo(xCurr, yCurr + 10);
        context_draw.stroke();
        context_draw.moveTo(xCurr, yCurr - 1);
        context_draw.lineTo(xCurr, yCurr - 10);
        context_draw.stroke();
    ...
    if (symmetry == "vertical"
        ...
        if (cursorSize == 0 && !isStroke) // specific cursor if hover at size 0
         {
            context_draw.beginPath();
            context_draw.moveTo(canvas_draw.width - xCurr + 1, yCurr);
            context_draw.lineTo(canvas_draw.width - xCurr + 10, yCurr);
            context_draw.stroke();
            context_draw.moveTo(canvas_draw.width - xCurr - 1, yCurr);
            context_draw.lineTo(canvas_draw.width - xCurr - 10, yCurr);
            context_draw.stroke();
            context_draw.moveTo(canvas_draw.width - xCurr, yCurr + 1);
            context_draw.lineTo(canvas_draw.width - xCurr, yCurr + 10);
            context_draw.stroke();
            context_draw.moveTo(canvas_draw.width - xCurr, yCurr - 1);
            context_draw.lineTo(canvas_draw.width - xCurr, yCurr - 10);
            context_draw.stroke();
    ...
    if (symmetry == "horizontal"
        ...
        if (cursorSize == 0 && !isStroke) // specific cursor if hover at size 0
         {
            context_draw.beginPath();
            context_draw.moveTo(xCurr + 1, canvas_draw.height - yCurr);
            context_draw.lineTo(xCurr + 10, canvas_draw.height - yCurr);
            context_draw.stroke();
            context_draw.moveTo(xCurr - 1, canvas_draw.height - yCurr);
            context_draw.lineTo(xCurr - 10, canvas_draw.height - yCurr);
            context_draw.stroke();
            context_draw.moveTo(xCurr, canvas_draw.height - yCurr + 1);
            context_draw.lineTo(xCurr, canvas_draw.height - yCurr + 10);
            context_draw.stroke();
            context_draw.moveTo(xCurr, canvas_draw.height - yCurr - 1);
            context_draw.lineTo(xCurr, canvas_draw.height - yCurr - 10);
            context_draw.stroke();
    ...
    if (symmetry == "center"
        ...
        if (cursorSize == 0 && !isStroke) // specific cursor if hover at size 0
         {
            context_draw.beginPath();
            context_draw.moveTo(canvas_draw.width - xCurr + 1, canvas_draw.height - yCurr);
            context_draw.lineTo(canvas_draw.width - xCurr + 10, canvas_draw.height - yCurr);
            context_draw.stroke();
            context_draw.moveTo(canvas_draw.width - xCurr - 1, canvas_draw.height - yCurr);
            context_draw.lineTo(canvas_draw.width - xCurr - 10, canvas_draw.height - yCurr);
            context_draw.stroke();
            context_draw.moveTo(canvas_draw.width - xCurr, canvas_draw.height - yCurr + 1);
            context_draw.lineTo(canvas_draw.width - xCurr, canvas_draw.height - yCurr + 10);
            context_draw.stroke();
            context_draw.moveTo(canvas_draw.width - xCurr, canvas_draw.height - yCurr - 1);
            context_draw.lineTo(canvas_draw.width - xCurr, canvas_draw.height - yCurr - 10);
            context_draw.stroke();
...
//# sourceMappingURL=utils_cursor.js.map