...
// normal cursor
function cursorDraw(context_draw, canvas_draw, xCurr, yCurr, forecolor, cursorsize, isStroke /*optional*/)
{
...
function cursorDrawStipple(context_draw, canvas_draw, xCurr, yCurr, forecolor, cursorsize)
{
    context_draw.clearRect(0, 0, canvas_draw.width, canvas_draw.height);
